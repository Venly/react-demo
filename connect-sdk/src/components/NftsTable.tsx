...
import { modalAtom, selectedNftAtom } from '../libs/atoms'
...
export default function Nfts({ 
  ...
  function openModal(modal: string, nft: NFT) {
    setSelectedNft(nft)
    setModal(modal)
  }
          ...
          <tr className="table-grid__row" key={index}>
            <td>
              <div className="table-grid__flex">
                <Skeleton width={70} height={68} borderRadius={12} />
                <p className="table-grid__title"><Skeleton width={150} height={14} /></p>
              </div>
            </td>
            <td>
              <div className="table-grid__block">
                <p className="table-grid__title"><Skeleton width={180} height={14} /></p>
                <div className="table-grid__copy">
                  <span className="table-grid__subtitle"><Skeleton width={120} height={14} /></span>
      ...
      return nfts?.map((nft: NFT) => {
        return (
          <tr className="table-grid__row" key={nft.id}>
            ...
            <td>
              <div className="table-grid__actions">
                <button className="btn btn--borderless" onClick={() => openModal('TransferNftModal', nft)}>
